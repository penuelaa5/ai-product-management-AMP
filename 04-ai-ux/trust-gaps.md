...
|---|---|---|---|
| **The Black-box Gap** | Can the user see why the AI decided? | Frequent friction, users work around Juno (2/5 closed) | _(not yet specified)_ |
...
**The Black-box Gap** (2/5). _(not yet specified)_
